...
function Client(opts) {
	...
	if (opts.connection instanceof self.Connection) self.connection = opts.connection;
	else if (opts.connection instanceof Client) self.connection = opts.connection.connection;
	else self.connection = new self.Connection(opts.connection)
...
Client.prototype.init = function () {
	...
	self.emit('initClient', self.clientInfo());
	*/
};
...
Client.prototype.emit = function (event, data) {
	this.send('events', event+'.'+self.uuid, data);
};
